...
const App = () => {
  ...
  return (
    <>
      {isOpen || hasFailed || hasWon || (
        <NavBar setOpen={setIsOpen} score={score} />
      )}
      <div className="App">
        ...
        {hasFailed && (
          <FailedModal setIsOpen={setIsOpen} word={word} score={score} />
        )}
        {hasWon && (
          <SuccessModal setIsOpen={setIsOpen} word={word} score={score} />
        )}
      </div>
    </>
  );
